...
test('inviting a teammate sends a request matching CreateInvitationRequest', async ({ page }) => {
...
test('accepting an invitation sends a request matching AcceptInvitationRequest', async ({
  page,
}) => {
